...
const TRANSLATIONS = {
  tr: {
    ...
    err_tek_pictionary:  "Tek modda sadece Resim Çiz ve Imposter oynanabilir!",
  ...
  en: {
    ...
    err_tek_pictionary:  "Only Pictionary and Imposter are available in single mode!",
  ...
  ar: {
    ...
    err_tek_pictionary:  "فقط الرسم وImposter متاحان في الوضع الفردي!",
